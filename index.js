...
//database
const espere = JSON.parse(fs.readFileSync('./database/grupos/espere.json')); const roleta = JSON.parse(fs.readFileSync('./database/grupos/cassino.json')); const porcentagem = JSON.parse(fs.readFileSync('./database/grupos/porcentagem.json')); const linkKaren = JSON.parse(fs.readFileSync('./menu/logos.json')); const infoBot = JSON.parse(fs.readFileSync('./info/infobot.json'));
//menu
...
//info do Bot
const donoOficial = [`5511954738489@s.whatsapp.net`] //Dono Oficial do Bot
const donos = JSON.parse(fs.readFileSync('./database/dono/donos.json'))
const premium = JSON.parse(fs.readFileSync('./database/premium/premiuns.json'))
